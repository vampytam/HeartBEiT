...
class Config:
    # Paths
    dir_ecg_plots = 'data/ecgimages/train'
    # dir_dataframes = ''
    # dir_ssd_plots = ''
    ...
    checkpoint_path = 'output/pretrain/checkpoint-19.pth'
    imagenet_checkpoint_path = 'output/pretrain/checkpoint-19.pth'
    image_size = 224
    # finetuning_percentage_iter = [.01, .1, .25, .5, 1]  # Use this amount of TRAINING data for finetuning
    finetuning_percentage_iter = [.5, 1]
    batch_size = 16
    ft_epochs = 20
    models = {
        # In use
        ...
        'vit': {'internal_identifier': 'vit', 'weights': checkpoint_path, 'name': 'HeartBEiT'},
    }
    ...
    outcome = 'output/heartbeit_finetune'
